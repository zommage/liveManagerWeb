...
import RotaryHeader from '../components/draw/RotaryHeader';
import DrawException from '../components/draw/Exception';
import UpDrawExcep from '../components/draw/UpDrawExcep';
import AddDrawExcep from '../components/draw/AddDrawExcep';
import EditDrawIssueNo from '../components/draw/EditIssueNo';
import DrawBaseValue from '../components/draw/BaseValue';

import SmsSwitch from '../components/sms/smsSwitch';
    ...
    render() {
        return (
            <Switch>
                ...
                <Route exact path="/app/draw/rataryHeader" component={RotaryHeader} />
                <Route exact path="/app/draw/exception" component={DrawException} />
                <Route exact path="/app/draw/editdrawexcep" component={UpDrawExcep} />
                <Route exact path="/app/draw/addDrawExcep" component={AddDrawExcep} />
                <Route exact path="/app/draw/issueNo" component={EditDrawIssueNo} />
                <Route exact path="/app/draw/baseValue" component={DrawBaseValue} />

                <Route exact path="/app/sms/switch" component={SmsSwitch} />
