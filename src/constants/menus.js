export const menus = [
    ...
    {
        key: '/app/draw', title: '开奖', icon: 'switcher',
        sub: [
            { key: '/app/draw/rataryHeader', title: '封盘时间', icon: '', },
            { key: '/app/draw/issueNo', title: '期号调整', icon: '', },
            { key: '/app/draw/exception', title: '开奖异常', icon: '', },
            { key: '/app/draw/baseValue', title: '基准值', icon: '', },
        ],
    },
    {
        key: '/app/sms', title: '短信', icon: 'mail',
        sub: [
            { key: '/app/sms/switch', title: '开关', icon: '', },
        ],
    },
    {
